...
public class WXBizMsgCrypt {
     ...
     * @throws AesException
     */
    public String decryptMsgData(String msgSignature, String timeStamp, String nonce, String cipherText) throws AesException {
        String signature = SHA1.gen(new String[]{token, timeStamp, nonce, cipherText});
        if (!signature.equals(msgSignature)) {
            throw new AesException(AesException.ValidateSignatureError);
        }
        // 解密
