package com.lulongji.base.utils;
...
public class EncryptUtil {
     ...
     * @return
     */
    public static String DESencode(String key, String res) {
     ...
     * @return
     */
    public static String DESdecode(String key, String res) {
     ...
     * @return
     */
    public static String AESencode(String key, String res) {
     ...
     * @return
     */
    public static String AESdecode(String key, String res) {
    ...
    public static void main(String[] args) {
        String KEYS = "1394B50BE076B525025E645D323D162A2F83E9151AD052F8";
        System.out.println(encrypt("200#" + "yuntongxun", KEYS));
        System.out.println(decrpyt(encrypt("200#yuntongxun" + "", KEYS)));
    }
    ...
    public static String decrpyt(String content) {
        String KEYS = "1394B50BE076B525025E645D323D162A2F83E9151AD052F8";
        try {
            byte[] keybyte = HexBin.decode(KEYS);
            ...
            byte[] result = cipher.doFinal(HexBin.decode(content));
